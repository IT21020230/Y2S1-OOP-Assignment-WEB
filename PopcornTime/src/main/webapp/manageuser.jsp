...
<head>
    <meta charset="UTF-8">
	<script type="text/javascript" src="assets/js/our/updateUser.js"></script>
                    ...
                    <div class="navbar-collapse" id="main-nav">
                        ...
                        <%
                            ...
                            <li class="nav-item m-auto">
                                <a href="${pageContext.request.contextPath }/user.jsp?user=<%=sessionUsername%>" class="btn btn-main btn-effect login-btn popup-with-zoom-anim">
                                    <i class="icon-user"></i><%=sessionUsername%>
                                </a>
            ...
            <div class="container">
                <div class="row">
					...
					%>
                        ...
                        <!-- Start of Contact Form -->
                        <form action="usercontrol" onsubmit="return validateUpdate()" method="post">
                            ...
                            <div class="form-group">
                            	...
                            	<input class="form-control input-box" type="text" name="user_id" value="<%=request.getParameter("user_id")%>" readonly>
							</div>
                            ...
                            <!-- Enter username -->
                            <div class="form-group">
                            	<label for="movie-input-field">Username</label>
                                <input class="form-control input-box" type="text" id="username" name="username" value="<%=resultSet.getString("username")%>" placeholder="Username" autocomplete="off">
                            </div>
                            
                            <!-- Enter password -->
                            <div class="form-group">
                            	<label for="movie-input-field">Password</label>
                                <input class="form-control input-box" type="password" id="password" name="password" value="<%=resultSet.getString("password")%>" placeholder="Password" autocomplete="off"
                                		pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,18}" title="Must contain at least one number and one uppercase and lowercase letter, and between 8 and 18 characters">
                            </div>
