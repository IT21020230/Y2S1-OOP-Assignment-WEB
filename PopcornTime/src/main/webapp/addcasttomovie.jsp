            ...
            <div class="container">
                <div class="row">
					...
					try{
						...
						String sql ="select c.celebrity_id, c.name from celebritytb c, moviecelebritytb mc where c.celebrity_id not in (select mc.celebrity from moviecelebritytb mc where mc.movie="+movieID+")";
				...
				%>
							...
							<input type="hidden" name="txtMovieID" value="<%=request.getParameter("movie_id")%>">
