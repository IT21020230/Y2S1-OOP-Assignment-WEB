...
<head>
	...
	<script type="text/javascript" src="assets/js/our/addUser.js"></script>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <!-- Start of Contact Form -->
                        <form action="usercontrol" onsubmit="return validateAddUser()" method="post">
                            ...
                            <div class="form-group">
                                <input class="form-control input-box" type="text" id="email" name="email" placeholder="E-mail" autocomplete="off"
                            ...
                            <!-- Enter username -->
                            <div class="form-group">
                                <input class="form-control input-box" type="text" id="username" name="username" placeholder="Username" autocomplete="off">
                            </div>
                            
                            <!-- Enter password -->
                            <div class="form-group">
                                <input class="form-control input-box" type="text" id="password" name="password" placeholder="Password" autocomplete="off"
                            ...
                            <div class="form-group text-center">
                                <button class="btn btn-main btn-effect" type="submit" name="btnAddUser" value="btnAddUser">Add User</button>
                            </div>
