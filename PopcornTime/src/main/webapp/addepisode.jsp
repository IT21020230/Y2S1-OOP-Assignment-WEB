...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="page-header overlay-gradient" style="background: url(assets/images/posters/movie-collection.jpg);">
            <div class="container">
                <div class="inner">
                    <h2 class="title">Add New Episode</h2>
                </div>
            </div>
        </section>
        <!-- =============== END OF PAGE HEADER =============== -->
                    ...
                    <div class="col-md-8 col-sm-12">
                        <form action="tvseriescontrol" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input class="form-control input-box" type="text" name="txtTVShowID" value="<%=request.getParameter("tvseries_id")%>" placeholder="TV Show ID - <%=request.getParameter("tvseries_id")%>" autocomplete="off" readonly required>
                            </div>
                            
                            <!-- Form Group -->
                            <div class="form-group">
                                <input class="form-control input-box" type="text" name="txtSeason" placeholder="Season" autocomplete="off" required>
                            </div>
                            
                            <!-- Form Group -->
                            <div class="form-group">
                                <input class="form-control input-box" type="text" name="txtEpisode" placeholder="Episode" autocomplete="off" required>
                            </div>
                            
                            <!-- Form Group -->
							<div class="form-group">
								<label for="movie-input-field">Movie</label>
								<input class="form-control-file" type = "file" name = "episode" id="movie-input-field" accept="video/mp4" required/>
							</div>
							
                            <!-- Form Group -->
                            <div class="form-group text-center">
                                <button class="btn btn-main btn-effect" type="submit" name="btnAddEpisode" value="addEpisode">Add Episode</button>
                            </div>
                        </form>
                        <!-- End of Contact Form -->
                    </div>
