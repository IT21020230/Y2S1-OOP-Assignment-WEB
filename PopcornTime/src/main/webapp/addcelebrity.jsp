...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="page-header overlay-gradient" style="background: url(assets/images/posters/movie-collection.jpg);">
            <div class="container">
                <div class="inner">
                    <h2 class="title">Add New Celebrity</h2>
                </div>
            </div>
        </section>
        <!-- =============== END OF PAGE HEADER =============== -->
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <form action="celebritycontrol" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input class="form-control input-box" type="text" name="txtCelebName" placeholder="Celebrity Name" autocomplete="off" required>
                            </div>
                            
                            <!-- Form Group -->
                            <div class="form-group mb20">
                                <textarea class="form-control textarea-box" rows="8" name="txtBiography" placeholder="Biography" required></textarea>
                            </div>
                            
                            <div class="form-group">
                            	<input class="form-control" type="date" name="CelebDOB" required pattern="\d{4}-\d{2}-\d{2}" placeholder="Date Of Birth">
							</div>
							...
							<!-- Form Group -->
							<div class="form-group">
								<label for="poster-image-input-field">Celebrity Image</label>
								<input class="form-control-file" type = "file" name = "posterImage" size = "50" id="poster-image-input-field" accept="image/jpeg" required>
							</div>
							
							<!-- Form Group -->
							<div class="form-group">
								<label for="banner-image-input-field">Celebrity Banner Image</label>
                            ...
                            <div class="form-group text-center">
                                <button class="btn btn-main btn-effect" type="submit" name="btnAddCelebrity" value="addcelebrity">Add Celebrity</button>
                            </div>
